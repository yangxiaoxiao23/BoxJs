...
(function(){
	...
	Usitrip.extend(usitrip.widget.MobilePhoneField, usitrip.event.UsitripEvent, {
		...
		doRender: function(el){
			...
			content += '</dl></div>';
			content += '<div class="area-box"><div class="areas"><i class="flag"></i><input name="' + this.areaname + '" class="areaname" value="' + zh + '"><em><!– –></em></div> <input name="' + this.name + '" class="phone" type="text" value="' + phoneInit + '" placeholder="' + this.initValue.placeholder + '" /><i class="tips">' + this.tipText +'</i></div>'
				+ '</div>';
			$(el).html(content);
